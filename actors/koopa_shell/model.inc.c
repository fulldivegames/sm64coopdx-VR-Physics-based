...
// Hammer Suit backpack variant. Its native shell UVs and geometry are kept
// intact; only the exterior's green texels are replaced with neutral black.
ALIGNED8 static const Texture vr_hammer_shell_front_texture[] = {
#include "actors/hammer_suit/black_shell_front.rgba16.inc.c"
};

ALIGNED8 static const Texture vr_hammer_shell_back_texture[] = {
#include "actors/hammer_suit/black_shell_back.rgba16.inc.c"
};
...
static const Gfx vr_hammer_shell_back_dl[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, vr_hammer_shell_back_texture),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&koopa_shell_seg8_lights_08027470.l, 1),
    gsSPLight(&koopa_shell_seg8_lights_08027470.a, 2),
...
static const Gfx vr_hammer_shell_front_dl[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, vr_hammer_shell_front_texture),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(koopa_shell_seg8_vertex_08028540, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
...
const Gfx vr_hammer_shell_dl[] = {
    ...
    gsSPDisplayList(vr_hammer_shell_back_dl),
    gsSPDisplayList(vr_hammer_shell_front_dl),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(koopa_shell_seg8_dl_08028A20),
