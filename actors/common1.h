...
extern const GeoLayout vr_rasengan_geo[];
extern const Gfx vr_rasengan_dl[];
extern const Gfx vr_rasengan_tornado_ring_dl[];
...
extern const GeoLayout vr_sonic_shoes_geo[];
extern const Gfx vr_sonic_shoes_pair_dl[];
extern const Gfx vr_sonic_shoe_left_dl[];
