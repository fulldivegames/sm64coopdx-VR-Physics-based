...
#define SM64COOPDX_VR_VERSION "v0.9.21"
#define SM64COOPDX_VR_PC_VERSION "v0.9.21"
#if defined(__ANDROID__)
#define SM64COOPDX_VR_CLIENT_VERSION SM64COOPDX_VR_VERSION
#else
#define SM64COOPDX_VR_CLIENT_VERSION SM64COOPDX_VR_PC_VERSION
#endif
