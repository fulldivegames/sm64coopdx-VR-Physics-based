...
Gfx *geo_vr_sonic_shoe(s32 callContext, struct GraphNode *node, void *context);
Gfx *geo_switch_vr_sonic_foot(s32 callContext, struct GraphNode *node, void *context);
