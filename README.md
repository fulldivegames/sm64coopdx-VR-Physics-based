...
> [!IMPORTANT]
> The current public release is **v0.8.6 — Multiplayer Updater and Release Notes Fix**. This is an active fan project: neither the PC nor Quest standalone edition has been tested across every level, headset, multiplayer situation, ROM hack, or mod combination. Occasional crashes or issues might occur.
