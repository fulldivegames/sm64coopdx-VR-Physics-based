...
2. Download `SM64-Co-Op-DX-VR-Quest-v0.5.9.apk` under **Assets**.
...
> [!IMPORTANT]
> Install v0.5.9 directly over an existing installation so the private ROM, save, and settings remain available. Do not uninstall the app first.
