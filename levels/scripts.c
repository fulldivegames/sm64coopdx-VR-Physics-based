...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_VR_FIREBALL,                vr_fireball_geo),
    LOAD_MODEL_FROM_GEO(MODEL_VR_RASENGAN,                vr_rasengan_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_VR_ELEPHANT_TRUNK,          vr_elephant_trunk_geo),
