# SM64 Co-Op DX VR for Quest v0.5.10
...
- Shared `/sdcard/SM64VR/mods/` and `/sdcard/SM64VR/dynos/packs/` loading, with legacy private directories retained as fallbacks
